...
class TestLMDBDataset(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_names = [
            "crag_17", "crag_17", "crag_17",
            "crag_35", "crag_35", "crag_35",
            "crag_1",  "crag_1",  "crag_1",
            "crag_61", "crag_61", "crag_61",
            "crag_34", "crag_34", "crag_34",
            "consep_5","consep_5","consep_5",
            "crag_10", "crag_10", "crag_10",
            "crag_64", "crag_64", "crag_64",
            "crag_51", "crag_51", "crag_51",
            "crag_13", "crag_13", "crag_13",
            "crag_53", "crag_53", "crag_53",
        ]
    ...
    def test_load_all_data(self):
        ...
        self.assertCountEqual(dataset_sample_names, self.sample_names,
    ...
    def test_filter_by_sample_names(self):
        ...
        self.assertEqual(actual_num_tiles, expected_num_tiles,
        ...
        for idx in range(len(dataset)):
            data = dataset[idx]
            self.assertIn('sample_name', data, "Data should contain 'sample_name' key.")
            self.assertIn(data['sample_name'], include_sample_names,
