...
N_CPUS=10
OMP_NUM_THREADS=$N_CPUS PYTHONPATH=/fast/AG_Kainmueller/jluesch/Pathology-Foundation-Model-Benchmark python src/benchmark/run/train.py --config $1 --job_id ${SLURM_JOB_ID} --model_name $2
